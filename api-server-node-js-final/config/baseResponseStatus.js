module.exports = {
    ...
    VERIFY_FAIL:{"isSuccess": false, "code": 3002, "message": "휴대폰 번호 인증에 실패했습니다. 다시 시도해주세요."},
    REQUEST_VERIFY_NUM_FIRST:{"isSuccess": false, "code": 3003, "message": "발급받은 인증번호가 없습니다."},
    USER_NOT_EXIST:{"isSuccess": false, "code": 3004, "message": "해당 번호로 가입된 회원이 존재하지 않습니다."},
    WITHDRAWAL_ACCOUNT:{"isSuccess": false, "code": 3005, "message": "탈퇴한 회원입니다."},
    SIGN_IN_PASSWORD_WRONG:{"isSuccess": false, "code": 3006, "message": "비밀번호가 일치하지 않습니다."},
